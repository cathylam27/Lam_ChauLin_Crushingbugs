...
(() => {
	...
	*/
	...
	function changeImageSet() {
		...
		// the second bug solution, but not working //	
		//let element = document.getElementById("pzlPieces");
	...
	function allowDrop(event) {
		...
		// the first bug solution
		if (this.childElementCount > 0) { return }

	//debugger;

		// if this.childeElementCount is greater than 0, don't execute anything else. Just exit the function
